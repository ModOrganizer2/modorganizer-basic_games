...
class GothicIRemakeModDataContent(mobase.ModDataContent):
...
class GothicIRemakeModDataChecker(mobase.ModDataChecker):
...
class GothicIRemakeGame(BasicGame):
    ...
    GameDocumentsDirectory = "%LOCALAPPDATA%/G1R/Saved/Config/Windows"
    GameSavesDirectory = "%LOCALAPPDATA%/G1R/Saved/SaveGames"
    ...
    def init(self, organizer: mobase.IOrganizer) -> bool:
        ...
        self.dataChecker = GothicIRemakeModDataChecker(organizer)
        self._register_feature(self.dataChecker)
        self._register_feature(GothicIRemakeModDataContent())
