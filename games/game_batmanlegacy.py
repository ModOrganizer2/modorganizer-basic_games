...
class BatmanLegacyModDataChecker(mobase.ModDataChecker):
...
class BatmanLegacyGame(BasicGame):
    ...
    GameShortName = "BatmanLegacy"
    GameSteamId = 215200
    GameBinary = "LEGOBatmanLotDK/Binaries/Win64/LEGOBatmanLotDK-Win64-Shipping.exe"
    GameDataPath = "LEGOBatmanLotDK"
    GameDataUE4SSRoot = "Binaries/Win64"
    GameDataPakMods = "Content/Paks/~Mods"
    GameDataMovieMods = "Content/Movies"
    GameDocumentsDirectory = "%LOCALAPPDATA%/LEGOBatmanLotDK/Saved/Config/Windows"
    GameSavesDirectory = "%LOCALAPPDATA%/LEGOBatmanLotDK/Saved/SaveGames"
    ...
    def init(self, organizer: mobase.IOrganizer) -> bool:
        ...
        self.dataChecker = BatmanLegacyModDataChecker(organizer)
        self._register_feature(self.dataChecker)
        self._register_feature(BatmanLegacyModDataContent())
