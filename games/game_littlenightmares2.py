...
class LittleNightmares2ModDataContent(mobase.ModDataContent):
...
class LittleNightmares2ModDataChecker(mobase.ModDataChecker):
...
class LittleNightmares2Game(BasicGame):
    ...
    GameShortName = "littlenightmares2"
    GameSteamId = 860510
    GameBinary = "EnhancedEdition/Helios/Binaries/Win64/Little_Nightmares_II_Enhanced-Win64-Shipping.exe"
    GameDataPath = "EnhancedEdition/Helios"
    GameDataUE4SSRoot = "Binaries/Win64"
    GameDataPakMods = "Content/Paks/~Mods"
    GameDataMovieMods = "Content/Movies"
    GameDocumentsDirectory = "%LOCALAPPDATA%/Helios/Saved/Config/Windows"
    GameSavesDirectory = "%LOCALAPPDATA%/Helios/Saved/SaveGames"
    ...
    def init(self, organizer: mobase.IOrganizer) -> bool:
        ...
        self.dataChecker = LittleNightmares2ModDataChecker(organizer)
        self._register_feature(self.dataChecker)
        self._register_feature(LittleNightmares2ModDataContent())
