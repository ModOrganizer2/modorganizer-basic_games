...
class EnotriaModDataContent(mobase.ModDataContent):
...
class EnotriaModDataChecker(mobase.ModDataChecker):
...
class EnotriaGame(BasicGame):
    ...
    GameShortName = "EnotriaTheLastSong"
    GameSteamId = 2102450
    GameBinary = "Enotria/Binaries/Win64/Enotria-Win64-Shipping.exe"
    GameDataPath = "Enotria"
    GameDataUE4SSRoot = "Binaries/Win64"
    GameDataPakMods = "Content/Paks/~Mods"
    GameDataMovieMods = "Content/Movies"
    GameDocumentsDirectory = "%LOCALAPPDATA%/Enotria/Saved/Config/Windows"
    GameSavesDirectory = "%LOCALAPPDATA%/Enotria/Saved/SaveGames"
    ...
    def init(self, organizer: mobase.IOrganizer) -> bool:
        ...
        self.dataChecker = EnotriaModDataChecker(organizer)
        self._register_feature(self.dataChecker)
        self._register_feature(EnotriaModDataContent())
