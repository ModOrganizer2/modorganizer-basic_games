...
class FinalFantasy7RemakeGame(BasicGame, mobase.IPluginFileMapper):
    ...
    def mappings(self) -> List[mobase.Mapping]:
        ...
        def create_mod_mappings(mod: mobase.IModInterface, priority: int) -> List[mobase.Mapping]:
            ...
            def file_visitor(file_name: str, entry: mobase.FileTreeEntry) -> mobase.IFileTree.WalkReturn:
                ...
                custom_mappings.append(mobase.Mapping(
                    src_path,
                    dest_path,
                    False,
                ))
        ...
        return [
            ...
            for mapping in create_mod_mappings(self._organizer.modList().getMod(mod_name), i)
        ]
