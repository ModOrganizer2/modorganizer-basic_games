...
class GothamKnightsModDataContent(mobase.ModDataContent):
...
class GothamKnightsModDataChecker(mobase.ModDataChecker):
...
class GothamKnightsGame(BasicGame):
    ...
    GameDocumentsDirectory = "%LOCALAPPDATA%/Mercury/Saved/Config/Windows"
    GameSavesDirectory = "%LOCALAPPDATA%/Mercury/Saved/SaveGames"
    ...
    def init(self, organizer: mobase.IOrganizer) -> bool:
        ...
        self.dataChecker = GothamKnightsModDataChecker(organizer)
        self._register_feature(self.dataChecker)
        self._register_feature(GothamKnightsModDataContent())
